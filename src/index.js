...
draws = [
    ...
    {
        date: new Date('2022-08-24'), numbers: ['05', '07', '36', '37', '40', '42'], stars: ['02'],
    },
    {
        date: new Date('2022-08-24'), numbers: ['03', '11', '16', '29', '38', '42'], stars: ['02'],
    },
    {
        date: new Date('2022-08-31'), numbers: ['05', '06', '08', '11', '37', '39'], stars: ['06'],
    },
];
